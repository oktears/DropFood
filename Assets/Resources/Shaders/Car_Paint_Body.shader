...
Shader "Chengzi/Car/Car_Paint_Body" {
...
//				o.I = reflect(-worldViewDir, worldNormal);
			...
			fixed4 frag(v2f i) : COLOR
			{
				...
				//	closeCubeColor = closeCubeColor * reflMaskColor  * _CloseFactor * _NearColor;
				//}
...
//					farCubeColor = texCUBE(_FarCube, mul(_Rotation, float4(i.I, 0)));
					farCubeColor = texCUBE(_FarCube, i.I);
					farCubeColor = farCubeColor  * reflMaskColor * _FarFactor;
				}
