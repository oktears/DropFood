...
Shader "Chengzi/Car/Car_Paint_Old" {
	...
	Properties{
		...
		//远景Cube
		_Cube("DistanceCube", CUBE) = "Black" { TexGen CubeReflect }
		//近景Cube
	...
	SubShader {
		...
		Pass{
			...
			fixed4 frag(v2f i) : SV_Target
			{
				...
				fixed4 finalColor;
				finalColor = (tintColor * _TintAmount) + (cubeColor + closeCubeColor) * fixed4(maskColor.rgb, 1) * _ReflAmount;
				return finalColor;
			}
