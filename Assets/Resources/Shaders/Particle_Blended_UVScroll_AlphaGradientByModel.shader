...
Shader "Chengzi/Particle/Blended_UVScroll_AlphaGradientByModel" {
		...
		Pass {
			...
			v2f vert(appdata_t v)
			{
				...
				if (v.texcoord.y > _ScrollController) {
			...
			fixed4 frag(v2f i) : COLOR
			{
				...
				fixed4 col = tex2D(_MainTex, i.texcoord) * _LightAmount;
				col.a = _TintColor.a * col.a * i.color.a;
