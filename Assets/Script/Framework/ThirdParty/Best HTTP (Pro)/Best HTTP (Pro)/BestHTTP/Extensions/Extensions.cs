...
namespace BestHTTP.Extensions
{
    public static class Extensions
    {
        ...
        internal static string Read(this string str, ref int pos, char block, bool needResult)
        {
            return str.Read(ref pos, (ch) => ch != block, needResult);
        }

        internal static string Read(this string str, ref int pos, Func<char, bool> block, bool needResult)
        {
            if (pos >= str.Length)
                return string.Empty;
        ...
        internal static string ReadPossibleQuotedText(this string str, ref int pos)
        {
            ...
            if (str[pos] == '\"')
            {
                ...
                result = str.Read(ref pos, (ch) => ch != ',' && ch != ';', true);
        ...
        internal static List<HeaderValue> ParseOptionalHeader(this string str)
        {
            ...
            {
                // Read key
                string key = str.Read(ref idx, (ch) => ch != '=' && ch != ',', true).TrimAndLower();
        ...
        internal static List<HeaderValue> ParseQualityParams(this string str)
        {
            ...
            while (idx < str.Length)
            {
                ...
                if (str[idx - 1] == ';')
                {
                    ...
                    qp.Value = str.Read(ref idx, ',', true);
                }
