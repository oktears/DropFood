...
namespace BestHTTP.SocketIO.Transports
{
    ...
    internal sealed class WebSocketTransport : ITransport
    {
        ...
        private void OnOpen(WebSocket ws)
        {
            ...
            // Send Ping Probe
            Send(new Packet(TransportEventTypes.Ping, SocketIOEventTypes.Unknown, "/", "probe", 0, 0));
        }
            ...
            switch (packet.TransportEvent)
            {
                ...
                case TransportEventTypes.Pong:
                    ...
                    if (packet.Payload == "probe")
                    {
                        ...
                        Send(new Packet(TransportEventTypes.Upgrade, SocketIOEventTypes.Unknown, "/", string.Empty, 0, 0));
                    }
